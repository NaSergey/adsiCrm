...
import { useIsMounted } from "@/shared/lib/use-has-mounted";
...
export function Header() {
  ...
  const visibleNavItems = isMounted ? navItems.filter(item => allowedPages.includes(item.href)) : [];
